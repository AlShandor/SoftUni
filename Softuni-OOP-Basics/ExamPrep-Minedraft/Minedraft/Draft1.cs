...
public class DraftManager1
{
    ...
    public string RegisterHarvester(List<string> arguments)
    {
        try
        {
            this.harvesters.Add(this.harvesterFactory.GetHarvester(arguments));
        }
    ...
    public string RegisterProvider(List<string> arguments)
    {
        try
        {
            this.providers.Add(this.providerFactory.GetProvider(arguments));
        }
        catch (ArgumentException ae)
        {
            return ae.Message;
